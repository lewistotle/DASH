   ...
   0000                     767 	.ds 8
                            ...
                            795 ;--------------------------------------------------------
                            796 	.area XSEG    (XDATA)
   0A67                     797 _pwm_init_channelNumber_1_1:
   0A67                     798 	.ds 1
   0A68                     799 _pwm_incrementDutyCycle_channelNumber_1_1:
   0A68                     800 	.ds 1
   0A69                     801 _pwm_decrementDutyCycle_channelNumber_1_1:
   0A69                     802 	.ds 1
   0A6A                     803 _pwm_getDutyCycle_channelNumber_1_1:
   0A6A                     804 	.ds 1
   0A6B                     805 _pwm_setDutyCycle_PARM_2:
   0A6B                     806 	.ds 1
   0A6C                     807 _pwm_setDutyCycle_channelNumber_1_1:
   0A6C                     808 	.ds 1
   0A6D                     809 _pwm_adjustDutyCycle_PARM_2:
   0A6D                     810 	.ds 1
   0A6E                     811 _pwm_adjustDutyCycle_channelNumber_1_1:
   0A6E                     812 	.ds 1
   0A6F                     813 _pwm_setDutyCycleAsPercentage_PARM_2:
   0A6F                     814 	.ds 1
   0A70                     815 _pwm_setDutyCycleAsPercentage_channelNumber_1_1:
   0A70                     816 	.ds 1
   0A71                     817 _pwm_getDutyCycleAsPercentage_channelNumber_1_1:
   0A71                     818 	.ds 1
                            819 ;--------------------------------------------------------
   ...
   3538                     862 _pwm_init:
                    ...
                    0000    869 	ar0 = 0x00
                    0001    870 	ar1 = 0x01
   3538 E5 82               871 	mov	a,dpl
   353A 90 0A 67            872 	mov	dptr,#_pwm_init_channelNumber_1_1
   353D F0                  873 	movx	@dptr,a
   ...
   353E 90 0A 67            875 	mov	dptr,#_pwm_init_channelNumber_1_1
   3541 E0                  876 	movx	a,@dptr
   3542 F5 82               877 	mov	dpl,a
   3544 02 03 0E            878 	ljmp	_pwm_init_projectSpecific
                            879 ;------------------------------------------------------------
                            ...
                            887 ;	-----------------------------------------
   3547                     888 _pwm_incrementDutyCycle:
   3547 E5 82               889 	mov	a,dpl
   3549 90 0A 68            890 	mov	dptr,#_pwm_incrementDutyCycle_channelNumber_1_1
   354C F0                  891 	movx	@dptr,a
   ...
   354D 90 0A 68            893 	mov	dptr,#_pwm_incrementDutyCycle_channelNumber_1_1
   3550 E0                  894 	movx	a,@dptr
   3551 F5 82               895 	mov	dpl,a
   3553 02 03 5D            896 	ljmp	_pwm_incrementDutyCycle_projectSpecific
                            897 ;------------------------------------------------------------
                            ...
                            905 ;	-----------------------------------------
   3556                     906 _pwm_decrementDutyCycle:
   3556 E5 82               907 	mov	a,dpl
   3558 90 0A 69            908 	mov	dptr,#_pwm_decrementDutyCycle_channelNumber_1_1
   355B F0                  909 	movx	@dptr,a
   ...
   355C 90 0A 69            911 	mov	dptr,#_pwm_decrementDutyCycle_channelNumber_1_1
   355F E0                  912 	movx	a,@dptr
   3560 F5 82               913 	mov	dpl,a
   3562 02 03 5E            914 	ljmp	_pwm_decrementDutyCycle_projectSpecific
                            915 ;------------------------------------------------------------
                            ...
                            923 ;	-----------------------------------------
   3565                     924 _pwm_getDutyCycle:
   3565 E5 82               925 	mov	a,dpl
   3567 90 0A 6A            926 	mov	dptr,#_pwm_getDutyCycle_channelNumber_1_1
   356A F0                  927 	movx	@dptr,a
   ...
   356B 90 0A 6A            929 	mov	dptr,#_pwm_getDutyCycle_channelNumber_1_1
   356E E0                  930 	movx	a,@dptr
   356F F5 82               931 	mov	dpl,a
   3571 02 03 5F            932 	ljmp	_pwm_getDutyCycle_projectSpecific
                            933 ;------------------------------------------------------------
                            ...
                            942 ;	-----------------------------------------
   3574                     943 _pwm_setDutyCycle:
   3574 E5 82               944 	mov	a,dpl
   3576 90 0A 6C            945 	mov	dptr,#_pwm_setDutyCycle_channelNumber_1_1
   3579 F0                  946 	movx	@dptr,a
   ...
   357A 90 0A 6C            948 	mov	dptr,#_pwm_setDutyCycle_channelNumber_1_1
   357D E0                  949 	movx	a,@dptr
   357E FA                  950 	mov	r2,a
   357F 90 0A 6B            951 	mov	dptr,#_pwm_setDutyCycle_PARM_2
   3582 E0                  952 	movx	a,@dptr
   3583 90 00 03            953 	mov	dptr,#_pwm_setDutyCycle_projectSpecific_PARM_2
   3586 F0                  954 	movx	@dptr,a
   3587 8A 82               955 	mov	dpl,r2
   3589 02 03 63            956 	ljmp	_pwm_setDutyCycle_projectSpecific
                            957 ;------------------------------------------------------------
                            ...
                            966 ;	-----------------------------------------
   358C                     967 _pwm_adjustDutyCycle:
   358C E5 82               968 	mov	a,dpl
   358E 90 0A 6E            969 	mov	dptr,#_pwm_adjustDutyCycle_channelNumber_1_1
   3591 F0                  970 	movx	@dptr,a
   ...
   3592 90 0A 6E            972 	mov	dptr,#_pwm_adjustDutyCycle_channelNumber_1_1
   3595 E0                  973 	movx	a,@dptr
   3596 FA                  974 	mov	r2,a
   3597 90 0A 6D            975 	mov	dptr,#_pwm_adjustDutyCycle_PARM_2
   359A E0                  976 	movx	a,@dptr
   359B 90 00 04            977 	mov	dptr,#_pwm_adjustDutyCycle_projectSpecific_PARM_2
   359E F0                  978 	movx	@dptr,a
   359F 8A 82               979 	mov	dpl,r2
   35A1 02 03 64            980 	ljmp	_pwm_adjustDutyCycle_projectSpecific
                            981 ;------------------------------------------------------------
                            ...
                            990 ;	-----------------------------------------
   35A4                     991 _pwm_setDutyCycleAsPercentage:
   35A4 E5 82               992 	mov	a,dpl
   35A6 90 0A 70            993 	mov	dptr,#_pwm_setDutyCycleAsPercentage_channelNumber_1_1
   35A9 F0                  994 	movx	@dptr,a
   ...
   35AA 90 0A 70            996 	mov	dptr,#_pwm_setDutyCycleAsPercentage_channelNumber_1_1
   35AD E0                  997 	movx	a,@dptr
   35AE FA                  998 	mov	r2,a
   35AF 90 0A 6F            999 	mov	dptr,#_pwm_setDutyCycleAsPercentage_PARM_2
   35B2 E0                 1000 	movx	a,@dptr
   35B3 90 00 05           1001 	mov	dptr,#_pwm_setDutyCycleAsPercentage_projectSpecific_PARM_2
   35B6 F0                 1002 	movx	@dptr,a
   35B7 8A 82              1003 	mov	dpl,r2
   35B9 02 03 65           1004 	ljmp	_pwm_setDutyCycleAsPercentage_projectSpecific
                           1005 ;------------------------------------------------------------
                           ...
                           1013 ;	-----------------------------------------
   35BC                    1014 _pwm_getDutyCycleAsPercentage:
   35BC E5 82              1015 	mov	a,dpl
   35BE 90 0A 71           1016 	mov	dptr,#_pwm_getDutyCycleAsPercentage_channelNumber_1_1
   35C1 F0                 1017 	movx	@dptr,a
   ...
   35C2 90 0A 71           1019 	mov	dptr,#_pwm_getDutyCycleAsPercentage_channelNumber_1_1
   35C5 E0                 1020 	movx	a,@dptr
   35C6 F5 82              1021 	mov	dpl,a
   35C8 02 03 66           1022 	ljmp	_pwm_getDutyCycleAsPercentage_projectSpecific
                           1023 	.area CSEG    (CODE)
